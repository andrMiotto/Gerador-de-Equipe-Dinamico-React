...
export default function UserGenerator() {
    ...
    const fetchUsers = async (genderFilters) => {
        setLoading(true);
        try {
    ...
    return (
        <div className="user-container">
            <header className="user-header">
                ...
                <button onClick={() => {
                    fetchUsers = ('https://randomuser.me/api/?results=5&gender=male');
                }}>Apenas Homens</button>
                <button onClick={() => {
                    fetchUsers = ('https://randomuser.me/api/?results=5&gender=female');
